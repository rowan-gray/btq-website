        ...
        <div className="grow">
          <main className="flex min-h-full flex-col items-center justify-center px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="mt-10 text-center">
              <h1 className="text-heading text-4xl font-semibold tracking-tight text-balance sm:text-5xl">
                This stop doesn&apos;t exist
              </h1>
              <p className="text-muted mt-4 text-lg font-medium text-pretty">
                Looks like this route isn&apos;t in service. Let&apos;s get you
                back on track.
              </p>
