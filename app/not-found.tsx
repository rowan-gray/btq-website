...
export default function RootLayout() {
  return (
    <div className="font-sans text-gray-950 antialiased dark:text-gray-100">
          ...
          <div className="py-32">
            <main className="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
              <div className="text-center">
                ...
                <h1 className="mt-4 text-5xl font-semibold tracking-tight text-balance text-heading sm:text-7xl">
                  Page not found
                </h1>
