...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body
        className={`${firaSans.className} flex min-h-screen flex-col bg-white text-gray-950 antialiased transition-colors duration-200 dark:bg-gray-950 dark:text-gray-100`}
      >
        <ThemeProvider>
          <FooterProvider>
            <AlertStripServer />
